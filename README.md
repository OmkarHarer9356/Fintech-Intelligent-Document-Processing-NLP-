...
Precision: 0.468 Recall: 0.465 F1-score: 0.467
...
Detect whether PDF is digital or scanned
Use:
pdfplumber for digital PDFs
pytesseract + pdf2image for scanned PDFs
Apply legal-focused text cleaning
...
Dockerized the pipeline to integrate both text based and pdf based inputs for entity recognition Image: fintech-doc on Docker Hub
